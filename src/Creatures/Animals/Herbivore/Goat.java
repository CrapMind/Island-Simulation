...
public class Goat extends Herbivore{
    ...
    @Getter
    private final CreatureType creatureType = CreatureType.GOAT;

    public Goat(double weight, int movingSpeed, double satiety) {
        super(weight, movingSpeed, satiety);
        this.setId(PublicData.goatId.incrementAndGet());
    }
}
